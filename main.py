...
def principal():
	...
	pointsList = mecanics.createObjects(window, 10, 20, points.Point)

	enemy.positionX, enemy.positionY = mecanics.randomPos(enemy, player)
	...
	while True:
		...
		#LOGICA
		player.positionX, player.positionY = mecanics.update(player.positionX, player.positionY, player)

		enemy.positionX, enemy.positionY = mecanics.attracted(enemy, player)
